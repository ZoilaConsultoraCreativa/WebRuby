        ...
        <div className="bg-background py-24 md:py-32">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="space-y-10 text-lg leading-relaxed text-foreground/80">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">1. Responsable del Tratamiento de Datos</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">2. Datos que recopilo</h2>
                        <div>
                            <h3 className="text-2xl font-headline text-foreground/90 mb-2">2.1. Datos entregados voluntariamente por el usuario</h3>
                        ...
                        <div>
                            <h3 className="text-2xl font-headline text-foreground/90 mb-2">2.2. Datos de navegación (recopilados automáticamente)</h3>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">3. Uso de Google Analytics</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">4. Finalidades del Tratamiento</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">5. Base legal del tratamiento</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">6. Conservación de los datos</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">7. Comunicación de datos a terceros</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">8. Cookies</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">9. Derechos del Usuario</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">10. Seguridad de la Información</h2>
                     ...
                     <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">11. Enlaces a sitios de terceros</h2>
                     ...
                     <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">12. Modificaciones a esta Política</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-headline text-foreground border-b pb-2">13. Contacto</h2>
